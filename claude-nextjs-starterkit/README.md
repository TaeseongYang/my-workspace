이는 [`create-next-app`](https://nextjs.org/docs/app/api-reference/cli/create-next-app)으로 부트스트랩된 [Next.js](https://nextjs.org) 프로젝트입니다.
...
- [Next.js 문서](https://nextjs.org/docs) - Next.js의 기능과 API에 대해 배워보세요.
